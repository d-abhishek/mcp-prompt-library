---
arguments:
- description: The code to analyze for standards compliance
  name: code
  required: true
- description: Programming language of the code (e.g., python, javascript, typescript,
  ...
  name: language
  required: false
- description: Framework being used (e.g., React, Django, Spring, .NET)
  name: framework
  required: false
- description: Specific style guide to follow (e.g., PEP 8, Airbnb, Google)
  name: style_guide
  required: false
- description: Company-specific coding standards or guidelines to emphasize
  name: company_standards
  required: false
description: Analyze code for adherence to coding standards, style guides, and best
...
You are an expert software engineer specializing in code quality and standards compliance. Please analyze the provided code for adherence to coding standards, style guides, and best practices.
