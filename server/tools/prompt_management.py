...
class PromptManagementTool(BaseTool):
    ...
    def smart_prompt_executor(self, query: str, auto_execute: bool = False) -> str:
        ...
        Returns:
            str: Prompt suggestion or execution result
        """
        try:
            # First, get the suggestion using list_prompts with query
            suggestion_result = self.list_prompts(include_content=False, query=query)
